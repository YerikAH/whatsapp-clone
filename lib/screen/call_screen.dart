            ...
            return ListTile(
              title: Text(
                ...
                style: const TextStyle(
                    color: ThemeApp.black, fontWeight: FontWeight.w500),
              ),
              subtitle: Row(
                children: [
                  Transform(
                      ...
                      transform: e.answer
                          ? Matrix4.rotationZ(-0.7)
                          : Matrix4.rotationZ(2.3),
                      child: Icon(
                        Icons.arrow_forward,
                        color: e.answer ? ThemeApp.greenPale : ThemeApp.red,
                      )),
                  Text(
                    "$count $dayFinal $monthFinal ${e.time} $pmOram",
